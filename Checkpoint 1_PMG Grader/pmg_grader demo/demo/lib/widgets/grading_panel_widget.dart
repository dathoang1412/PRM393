...
class GradingPanelWidget extends StatelessWidget {
                  ...
                  child: Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ElevatedButton.icon(
                            onPressed: isAiGrading ? null : onAskAi,
                            icon: isAiGrading
                                ? const SizedBox(
                                    width: 16,
                                    height: 16,
                            ...
                            label: Text(isAiGrading ? 'AI grading...' : 'Chấm bằng AI'),
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      'No rubric imported. AI will use the current criteria.',
                          ...
                          if (submission.hasAiGraded) ...[
                            ...
                            _buildAiComment(submission.aiComment),
                            const SizedBox(height: 20),
                            ElevatedButton.icon(
                              ...
                              children: [
                                ...
                                Builder(
                                  builder: (context) {
                                    ...
                                    return Text(
                                      '${t.toStringAsFixed(1)} / ${exam.totalMaxScore10.toStringAsFixed(1)}',
                                      style: GoogleFonts.outfit(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          onTap: () {
            if (_isDefaultZeroValue(controller.text)) {
              controller.clear();
            }
          },
  ...
  Widget _buildAiComment(String comment) {
    final lines = _formatAiCommentLines(comment);
    if (lines.isEmpty) {
      return Text(
        'No comment returned.',
        style: GoogleFonts.inter(
    ...
    return Column(
      ...
      children: lines.map((line) {
        ...
        final label = hasLabel ? line.substring(0, separatorIndex + 1) : null;
        final body = hasLabel ? line.substring(separatorIndex + 1).trim() : line;
  ...
  List<String> _formatAiCommentLines(String comment) {
  ...
  bool _isDefaultZeroValue(String value) {
