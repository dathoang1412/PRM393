...
- **search_topic** — Parameters: `keyword`
- **view_publication** — Parameters: `publication_title`, `publication_year`
- **view_journal** — Parameters: `journal_name`
- **view_keyword** — Parameters: `keyword`
- **export_pdf** — Parameters: `topic`
